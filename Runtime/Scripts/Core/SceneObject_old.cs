...
public class SceneObjectOld
{
    ...
    public static implicit operator string(SceneObjectOld sceneObject)
    {
        return sceneObject.m_SceneName;
    }

    public static implicit operator SceneObjectOld(string sceneName)
    {
        return new SceneObjectOld() { m_SceneName = sceneName };
    }
}

#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(SceneObjectOld))]
public class SceneObjectOldEditor : PropertyDrawer
{
