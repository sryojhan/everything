...
public sealed class ButtonAttribute : Attribute
{
    ...
    /// </summary>
    [PublicAPI]
    public EasyButtons.ButtonMode Mode { get; set; } = EasyButtons.ButtonMode.AlwaysEnabled;
    ...
    /// </summary>
    [PublicAPI]
    public EasyButtons.ButtonSpacing Spacing { get; set; } = EasyButtons.ButtonSpacing.None;
